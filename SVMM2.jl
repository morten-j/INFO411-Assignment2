...
using MLJ, Random, Printf, DataFrames, Printf, Plots, MLJLinearModels, CSV, Statistics
...
# ╔═╡ 2e7dce9a-9a34-4e35-a185-72f25b415a11
using MLJLIBSVMInterface, LIBSVM

# ╔═╡ 42392293-61b6-4efb-894b-acf25ebcd65b
using  PlutoUI, HypertextLiteral

# ╔═╡ 60dad48f-14ef-4886-8d69-2919937c39d7
using MLBase
...
# ╔═╡ 19819e8c-9243-4e2e-9ad8-20c9cc91fd5f
    # Set y-axis limits and ticks to keep them stable

    plot!(1:degree, T4a_accu_te, label="Testing", marker=:d)

# ╔═╡ 634ffc6e-fcc3-4674-9704-d008d5765489
begin
    svc_model = SVC(kernel=LIBSVM.Kernel.Polynomial)#, degree=Int32(2), cost=0.8);
end

# ╔═╡ c17970d0-44ea-4c4c-baef-acdacc42c10c
params(svc_model) 
...
# ╔═╡ 87c943e3-b02e-4e5a-9838-5546389e22b8
rep.history[1].per_fold
...
# ╔═╡ a2743f11-2270-4761-a2b5-47ec765de790
res = rep.plotting
...
# ╔═╡ 71117dab-f3b0-4447-81d4-47a014d31c21
accuracy(yhat, cyt)

# ╔═╡ 3b092cdb-f76a-419c-a22a-04350b55b0d6
ytehat = MLJ.predict(m, Xc)  

# ╔═╡ 2757d33d-61c5-4176-90a0-afe394089a76
accuracy(ytehat, cy)

# ╔═╡ ecbb1f66-d609-4c01-af02-ec7d81f50105
misclassification_rate(yhat, cyt)

# ╔═╡ 1cb2a9a5-bb63-4a43-9419-204bf1bc7ae3
 confusmat(2, Array{Int32}(cyt), Array{Int32}(yhat))
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "76639b654f504cea5131c427527c07769fac17c7"
...
git-tree-sha1 = "8f54987aa15794eede3fc7d2143d693daeac7aa4"
